...
\begin{enumerate}
  ...
  \begin{enumerate}[label=(\alph*)]
    \item Modificar a região na figura I.3 tomando como ordenada para cada $x$ o valor $2x^2$ em vex de $x^2$. Desenhar a nova figura. Seguindo neste caso os passos principais de desenvolvimento anterior e comparando ambos, estudando a repercussão da mudança no cálculo de $A$. Efetue o mesmo se a ordenada em cada $x$ é:
    \item $3x^2$,
    \item $\dfrac{1}{4}x^2$,
    \item $2x^2 + 1$,
    \item $ax^2 + c$,
